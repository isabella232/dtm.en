...
uuid: 10255a3a-6eb9-4d5c-88cd-0c4698f1da68
index: y
internal: n
snippet: y
---
...
* [Default Roles](groups.md#section_929207D4799848D39EC775B82494C2BE) 
* [Migrated Groups for Existing Customers](groups.md#section_5C1B163F872B49D180BC06205964288D)
...
1. Click **[!UICONTROL Edit]** next to an existing group.
   ...
   You can also invite users while creating new groups as explained in [Create a New Group](groups.md#task_D08D33C542C444469636CA288B631FB5). 
...
1. Fill in the fields:
   ...
   **Tool Check Boxes: **(Optional) Select the desired check box next to any tools to restrict access to those tools. If the check box is selected, users in this group cannot create or modify the selected tools and related tool settings in rules. By default, all users in the group have access to all tools.
   ...
   A green checkmark (  ![](assets/icon_checkbox.png) ) next to a tool indicates that the corresponding tool is currently installed for this property.
...
1. Edit the desired fields, as explained in [Create a New Group](groups.md#task_D08D33C542C444469636CA288B631FB5).
1. Click **[!UICONTROL Save Group]**.
