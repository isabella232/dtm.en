...
uuid: ebbf665c-bffa-4412-878d-1f0e39b32a65
index: y
internal: n
snippet: y
---
...
1. Select the type of interaction you want to track, such as mouse clicks, or submitting a form.  ![](assets/condition_event_based.png)
   ...
   For more information, see [Event Types](t-rules-event-conditions.md#concept_B1C6169D8B354207AEE0E4965E6421B1). 
...
1. Indicate the name of the tag you want to track, and additional properties the tag has that you want to match.
   ...
   See [Using the CSS Selector](t-rules-event-conditions.md#concept_DDF500DCB8214658AEDECDE69ED1D4AF) for information about finding the correct element tag. 
...
<table id="table_6C82CFB54C9E4D6FA47EC4AB414BA5EC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A date element changed. This event lets you select a specific data element to use as a trigger. For more information on a possible use case, see <a href="add-aem-contextub-tool.md#concept_F0D713695CA54807B6E2B66842421C32" format="dita" scope="local"> Add Adobe Experience Manager ContextHub Tool </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [Example with Unique Element](t-rules-event-conditions.md#section_26F8A20D69624C398A64510C4554B633) 
* [Example with Similar Elements](t-rules-event-conditions.md#section_C37AF283219445E885CBDF269DCB8E36) 
* [CSS Selector Limitations](t-rules-event-conditions.md#section_40A54DA0259743088337EB017432991F)
...
1. Access the [!UICONTROL CSS Selector] widget within DTM by clicking the  ![](assets/icon_css_selector.png) icon while [creating a rule](t-rules-event-conditions.md#task_A122DE72110F4579A91F9D96D92D39FC).
...
1. Finish configuring the rule as described in [Create conditions for event-based rules](t-rules-event-conditions.md#task_A122DE72110F4579A91F9D96D92D39FC).
...
* [Analytics Variables](t-rules-event-conditions.md#section_3A7FD01807314C878B308FE3D0FA2AAA) 
* [Custom Script](t-rules-event-conditions.md#section_1603B0C6B6604EC98C19FC0C621D3AA5)
